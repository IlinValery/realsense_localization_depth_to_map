...
from subscribers import T265subscriber
...
if __name__ == "__main__":
    ...
    # T265 - Издатель
    pose_subscriber = T265subscriber(T265) # подписчик
    T265.attach(pose_subscriber)# Pose подписан на Т265
    ...
    D435.start_sensor()
    if not is_device:
        time.sleep(0.250)  # TODO: include difference here (computers are different)
    T265.start_sensor()
